...
{#if open}
	...
	>
		...
		>
			...
			<h2 id="signup-prompt-title" class="modal-title">
				Unlock High-Quality PDFs & Cloud Backup
			</h2>

			<p class="modal-description">
				Sign up for free to get premium features:
			</p>
			...
			<p class="modal-footer-text">
				Free accounts include 12 saved invoices with cloud backup.
			</p>
		</div>
	</div>
{/if}

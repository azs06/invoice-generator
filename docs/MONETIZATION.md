...
| Server-side PDF (Browser Rendering) | ❌ (or 3/mo teaser) | ✅ Marketed unlimited; undisclosed 1000/mo anti-abuse ceiling (~30x real usage, ~$0.38 worst-case cost — docs/COST_ANALYSIS.md) | Done — gated + hourly & monthly quotas |
